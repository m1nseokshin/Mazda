    ...
    return (
      <div>
        ...
        <div className="about-main-container">
          <Image className="about-main-img" src={Main} alt="Mazda" priority  data-aos="fade"  data-aos-easing="ease-in-out" data-aos-once="true"  />
        ...
        <div className="about-content-container2">
          <div className="about-content-textbox">
            ...
            <div className="subtitle-left">마쓰다는 자동차가 만들어지고 사용이 끝날 때까지 자동차가 배출하는 배출에 대한 책임을 집니다. <br />자동차의 이산화탄소 배출량을 줄이기 위해 마쓰다는 자동차 제조, 배송, 사용 및 재활용의 환경적 부담을 줄일 수 있는 영역을 정확히 파악할 수 있는 라이프 사이클 평가를 사용합니다.</div>
          </div>
